...
print(f"toRightOf Example -> Element to the right of twitter icon has ref: {facebook_icon.get_attribute('href')}")

#toLeftOf -> element to the left of another
...
#near -> element close to another (closest will be chosen by default if equal then left will be chosen)
...
or_example = driver.find_element(By.XPATH, "//td[text()='Time' or text()='Frank']")
...
print(f"\nChild Example -> Found {len(rows)} columns in the first table")
...
'''
'''
#Ancestors - get the table element that is an ancestor of a cell
...
#Xpath
# Absoulte Path: /html/body/div[2]/div[7]/div/div[2]/div[2]/span/span/g-popup/div[1]/div
# Relative XPath: /html/body/div[2]/div[7]/div/div[2]/div[2]/span/span/g-popup/div[1]/div
